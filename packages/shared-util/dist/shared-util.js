...
function Nt() {
  return Be || (Be = 1, process.env.NODE_ENV !== "production" && (function() {
    ...
    function r(l) {
      ...
      if (y) {
        y = console;
        var g = y.error, R = typeof Symbol == "function" && Symbol.toStringTag && l[Symbol.toStringTag] || l.constructor.name || "Object";
        return g.call(
          y,
    ...
    function u(l, y, g, R, z, Te) {
      ...
      if (H.call(y, "key")) {
        A = e(l);
        var X = Object.keys(y).filter(function(kt) {
          return kt !== "key";
        });
...
React keys must be passed directly to JSX without using spread:
  ...
  <%s key={someKey} {...props} />`,
      ...
      if (A = null, g !== void 0 && (r(g), A = "" + g), o(y) && (r(y.key), A = "" + y.key), "key" in y) {
        g = {};
        for (var Oe in y)
          Oe !== "key" && (g[Oe] = y[Oe]);
      } else g = y;
    ...
    var U, te = {}, L = S.react_stack_bottom_frame.bind(
      S,
      i
    )(), re = K(n(i)), de = {};
...
var Ie;
function Ct() {
  return Ie || (Ie = 1, process.env.NODE_ENV === "production" ? pe.exports = _t() : pe.exports = Nt()), pe.exports;
}
var k = Ct();
const Pt = ({ error: e, resetError: t }) => /* @__PURE__ */ k.jsx("div", { className: "min-h-screen bg-gradient-to-br from-red-50 to-orange-50 dark:from-red-950 dark:to-orange-950 flex items-center justify-center p-4", children: /* @__PURE__ */ k.jsxs("div", { className: "max-w-md w-full", children: [
  /* @__PURE__ */ k.jsx("div", { className: "flex justify-center mb-6", children: /* @__PURE__ */ k.jsx("div", { className: "w-20 h-20 bg-red-100 dark:bg-red-900 rounded-full flex items-center justify-center", children: /* @__PURE__ */ k.jsx(
    "svg",
    {
  ...
  /* @__PURE__ */ k.jsx("h1", { className: "text-3xl font-bold text-center text-gray-900 dark:text-white mb-3", children: "Oops! Something Went Wrong" }),
  /* @__PURE__ */ k.jsx("p", { className: "text-center text-gray-600 dark:text-gray-300 mb-6", children: "模块加载失败。你可以关闭错误提示以尝试重新渲染当前界面，或重新加载页面。" }),
  /* @__PURE__ */ k.jsxs("div", { className: "bg-white dark:bg-gray-800 rounded-lg p-4 mb-6 border border-red-200 dark:border-red-800", children: [
    /* @__PURE__ */ k.jsx("p", { className: "text-sm font-mono text-red-600 dark:text-red-400 break-words", children: e?.message || "Unknown error" }),
    e?.stack && /* @__PURE__ */ k.jsxs("details", { className: "mt-3 cursor-pointer", children: [
      /* @__PURE__ */ k.jsx("summary", { className: "text-xs text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300", children: "查看堆栈信息" }),
      /* @__PURE__ */ k.jsx("pre", { className: "mt-2 text-xs text-gray-600 dark:text-gray-300 overflow-auto max-h-40 bg-gray-50 dark:bg-gray-900 p-2 rounded", children: e.stack })
    ] })
  ] }),
  /* @__PURE__ */ k.jsxs("div", { className: "flex gap-3", children: [
    /* @__PURE__ */ k.jsx(
      "button",
      {
        onClick: t,
  ...
  /* @__PURE__ */ k.jsx("p", { className: "text-center text-gray-500 dark:text-gray-400 text-xs mt-4", children: "若问题持续存在，请查看控制台或联系开发人员。" })
] }) });
class ln extends rt.Component {
  constructor(t) {
  ...
  componentDidCatch(t, r) {
    console.error("ErrorBoundary caught:", t, r), this.setState({ errorInfo: r });
  }
  resetError = () => {
    this.setState({ hasError: !1, error: null, errorInfo: null });
  };
  render() {
    return this.state.hasError ? /* @__PURE__ */ k.jsx(Pt, { error: this.state.error, resetError: this.resetError }) : this.props.children;
  }
}
function nt(e, t) {
  return function() {
...
const vt = Re("string"), j = Re("function"), it = Re("number"), ae = (e) => e !== null && typeof e == "object", Ut = (e) => e === !0 || e === !1, me = (e) => {
  if (ge(e) !== "object")
    return !1;
  const t = Fe(e);
  return (t === null || t === Object.prototype || Object.getPrototypeOf(t) === null) && !(st in e) && !(we in e);
}, Lt = (e) => {
  if (!ae(e) || ie(e))
    return !1;
  try {
...
}, Dt = D("Date"), Bt = D("File"), It = D("Blob"), qt = D("FileList"), $t = (e) => ae(e) && j(e.pipe), Mt = (e) => {
  let t;
...
}, Ht = D("URLSearchParams"), [zt, Jt, Wt, Vt] = ["ReadableStream", "Request", "Response", "Headers"].map(D), Yt = (e) => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const Kt = (e, t, r, { allOwnKeys: n } = {}) => (ce(t, (s, i) => {
  r && j(s) ? e[i] = nt(s, r) : e[i] = s;
}, { allOwnKeys: n }), e), Xt = (e) => (e.charCodeAt(0) === 65279 && (e = e.slice(1)), e), Gt = (e, t, r, n) => {
  ...
  for (; t-- > 0; )
    r[t] = e[t];
  return r;
}, tr = /* @__PURE__ */ ((e) => (t) => e && t instanceof e)(typeof Uint8Array < "u" && Fe(Uint8Array)), rr = (e, t) => {
  ...
  for (; (r = e.exec(t)) !== null; )
    n.push(r);
  return n;
}, sr = D("HTMLFormElement"), or = (e) => e.toLowerCase().replace(
  /[-_\s]([a-z\d])(\w*)/g,
  function(r, n, s) {
    return n.toUpperCase() + s;
  }
), qe = (({ hasOwnProperty: e }) => (t, r) => e.call(t, r))(Object.prototype), ir = D("RegExp"), lt = (e, t) => {
...
function fr(e) {
  return !!(e && j(e.append) && e[st] === "FormData" && e[we]);
}
const dr = (e) => {
  ...
  return r(e, 0);
}, pr = D("AsyncFunction"), hr = (e) => e && (ae(e) || j(e)) && j(e.then) && j(e.catch), ut = ((e, t) => e ? setImmediate : t ? ((r, n) => (J.addEventListener("message", ({ source: s, data: i }) => {
  s === J && i === r && n.length && n.shift()();
}, !1), (s) => {
...
const wr = a.toFlatObject(a, {}, null, function(t) {
...
function Se(e, t, r) {
  ...
  function u(f, b, h) {
    ...
    if (f && !h && typeof f == "object") {
      ...
      else if (a.isArray(f) && Er(f) || (a.isFileList(f) || a.endsWith(b, "[]")) && (x = a.toArray(f)))
        return b = pt(b), x.forEach(function(O, _) {
          !(a.isUndefined(O) || O === null) && t.append(
            // eslint-disable-next-line no-nested-ternary
            o === !0 ? $e([b], _, i) : o === null ? b : b + "[]",
            d(O)
          );
        }), !1;
    }
    return Ce(f) ? !0 : (t.append($e(h, b, i), d(f)), !1);
  }
  const m = [], w = Object.assign(wr, {
    defaultVisitor: u,
    convertValue: d,
    isVisitable: Ce
  });
  function S(f, b) {
    if (!a.isUndefined(f)) {
      ...
      m.push(f), a.forEach(f, function(x, C) {
...
}, Rr = typeof URLSearchParams < "u" ? URLSearchParams : ve, Sr = typeof FormData < "u" ? FormData : null, xr = typeof Blob < "u" ? Blob : null, Tr = {
  isBrowser: !0,
  classes: {
    URLSearchParams: Rr,
    FormData: Sr,
...
}, Ue = typeof window < "u" && typeof document < "u", Pe = typeof navigator == "object" && navigator || void 0, Or = Ue && (!Pe || ["ReactNative", "NativeScript", "NS"].indexOf(Pe.product) < 0), Ar = typeof WorkerGlobalScope < "u" && // eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope && typeof self.importScripts == "function", kr = Ue && window.location.href || "http://localhost", _r = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  hasBrowserEnv: Ue,
...
function Nr(e, t) {
  return Se(e, new N.classes.URLSearchParams(), {
    visitor: function(r, n, s, i) {
      return N.isNode && a.isBuffer(r) ? (this.append(n, r.toString("base64")), !1) : i.defaultVisitor.apply(this, arguments);
    },
    ...t
  });
}
...
function yt(e) {
  function t(r, n, s, i) {
    ...
    return o = !o && a.isArray(s) ? s.length : o, p ? (a.hasOwnProp(s, o) ? s[o] = [s[o], n] : s[o] = n, !c) : ((!s[o] || !a.isObject(s[o])) && (s[o] = []), t(r, n, s[o], i) && a.isArray(s[o]) && (s[o] = Pr(s[o])), !c);
  }
...
const le = {
  ...
  transformRequest: [function(t, r) {
    ...
    return i || s ? (r.setContentType("application/json", !1), jr(t)) : t;
  }],
...
let F = class {
  ...
  set(t, r, n) {
    ...
    function i(c, p, d) {
      ...
      (!m || s[m] === void 0 || d === !0 || d === void 0 && s[m] !== !1) && (s[m || p] = be(c));
    }
    const o = (c, p) => a.forEach(c, (d, u) => i(d, u, p));
...
a.freezeMethods(F);
function ke(e, t) {
  const r = this || le, n = t || r, s = F.from(n.headers);
  let i = n.data;
...
const Ee = (e, t, r = 3) => {
  ...
  const s = qr(50, 250);
  return $r((i) => {
    const o = i.loaded, c = i.lengthComputable ? i.total : void 0, p = o - n, d = s(p), u = o <= c;
    n = o;
    const m = {
      loaded: o,
      total: c,
...
}, We = (e) => (...t) => a.asap(() => e(...t)), Mr = N.hasStandardBrowserEnv ? /* @__PURE__ */ ((e, t) => (r) => (r = new URL(r, N.origin), e.protocol === r.protocol && e.host === r.host && (t || e.port === r.port)))(
  new URL(N.origin),
  N.navigator && /(msie|trident)/i.test(N.navigator.userAgent)
) : () => !0, Hr = N.hasStandardBrowserEnv ? (
...
const Rt = (e) => {
  ...
  if (t.headers = o = F.from(o), t.url = mt(gt(t.baseURL, t.url, t.allowAbsoluteUrls), e.params, e.paramsSerializer), c && o.set(
    "Authorization",
  ...
  if (N.hasStandardBrowserEnv && (n && a.isFunction(n) && (n = n(t)), n || n !== !1 && Mr(t.url))) {
    const p = s && i && Hr.read(i);
    p && o.set(s, p);
  }
  return t;
}, Wr = typeof XMLHttpRequest < "u", Vr = Wr && function(e) {
  return new Promise(function(r, n) {
    const s = Rt(e);
    let i = s.data;
    const o = F.from(s.headers).normalize();
    let { responseType: c, onUploadProgress: p, onDownloadProgress: d } = s, u, m, w, S, f;
    function b() {
      S && S(), f && f(), s.cancelToken && s.cancelToken.unsubscribe(u), s.signal && s.signal.removeEventListener("abort", u);
    }
    ...
    "onloadend" in h ? h.onloadend = x : h.onreadystatechange = function() {
      ...
      const v = _ && _.message ? _.message : "Network Error", I = new E(v, E.ERR_NETWORK, e, h);
      I.event = _ || null, n(I), h = null;
    }, h.ontimeout = function() {
      let _ = s.timeout ? "timeout of " + s.timeout + "ms exceeded" : "timeout exceeded";
      const v = s.transitional || bt;
      s.timeoutErrorMessage && (_ = s.timeoutErrorMessage), n(new E(
        _,
        v.clarifyTimeoutError ? E.ETIMEDOUT : E.ECONNABORTED,
        e,
        h
      )), h = null;
    }, i === void 0 && o.setContentType(null), "setRequestHeader" in h && a.forEach(o.toJSON(), function(_, v) {
      h.setRequestHeader(v, _);
  ...
  if (!s)
    return !1;
  const c = s && he(Xe), p = s && (typeof Ge == "function" ? /* @__PURE__ */ ((f) => (b) => f.encode(b))(new Ge()) : async (f) => new Uint8Array(await new r(f).arrayBuffer())), d = i && c && Ze(() => {
    let f = !1;
    const b = new r(N.origin, {
      body: new Xe(),
      method: "POST",
      get duplex() {
        return f = !0, "half";
    ...
    return f && !b;
  }), u = o && c && Ze(() => a.isReadableStream(new n("").body)), m = {
    stream: u && ((f) => f.body)
  };
  ...
  return async (f) => {
    ...
    let M = Yr([C, O && O.toAbortSignal()], _), H = null;
    ...
    try {
      ...
      const U = i && "credentials" in r.prototype, te = {
        ...ue,
        signal: M,
      ...
      if (u && (v || re && q)) {
        ...
        const y = a.toFiniteNumber(L.headers.get("content-length")), [g, R] = v && Je(
          y,
          Ee(We(v), !0)
        ) || [];
        L = new n(
      ...
      P = P || "text";
      let de = await m[a.findKey(m, P) || "text"](L, f);
      ...
      throw q && q(), U && U.name === "TypeError" && /Load failed|fetch/i.test(U.message) ? Object.assign(
        new E("Network Error", E.ERR_NETWORK, f, H),
        {
          cause: U.cause || U
        }
      ) : E.from(U, U && U.code, f, H);
    }
  };
}, en = /* @__PURE__ */ new Map(), St = (e) => {
  let t = e && e.env || {};
  ...
  let o = i.length, c = o, p, d, u = en;
  for (; c--; )
    p = i[c], d = u.get(p), d === void 0 && u.set(p, d = c ? /* @__PURE__ */ new Map() : Qr(t)), u = d;
  return d;
};
St();
const Le = {
...
const Qe = (e) => `- ${e}`, tn = (e) => a.isFunction(e) || e === null || e === !1;
function rn(e, t) {
  e = a.isArray(e) ? e : [e];
  const { length: r } = e;
  let n, s;
  ...
  for (let o = 0; o < r; o++) {
    n = e[o];
    let c;
    if (s = n, !tn(n) && (s = Le[(c = String(n)).toLowerCase()], s === void 0))
...
function et(e) {
  return _e(e), e.headers = F.from(e.headers), e.data = ke.call(
    e,
    e.transformRequest
  ), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), xt.getAdapter(e.adapter || le.adapter, e)(e).then(function(n) {
    return _e(e), n.data = ke.call(
      e,
      e.transformResponse,
      n
    ), n.headers = F.from(n.headers), n;
  }, function(n) {
    return Et(n) || (_e(e), n && n.response && (n.response.data = ke.call(
      e,
      e.transformResponse,
      n.response
...
xe.transitional = function(t, r, n) {
  function s(i, o) {
    return "[Axios v" + Tt + "] Transitional option '" + i + "'" + o + (n ? ". " + n : "");
  }
  return (i, o, c) => {
    if (t === !1)
      throw new E(
...
function At(e) {
  const t = new W(e), r = nt(W.prototype.request, t);
...
T.mergeConfig = V;
T.AxiosHeaders = F;
T.formToJSON = (e) => yt(a.isHTMLForm(e) ? new FormData(e) : e);
    ...
    if (t.code === 0 || t.code === 200) {
      switch (code) {
        ...
        case 500:
          ...
          break;
        default:
          return console.error(t.message, "unknown error");
      }
      return Promise.reject(new Error(t.message || "Error"));
    }
    return t.data != null ? t.data : t;
  },
  (e) => {
    if (e.response) {
      const { status: t } = e.response;
      switch (t) {
        case 401:
          localStorage.removeItem("token");
          break;
        ...
        case 500:
          ...
          break;
        default:
          console.error(e.response.data?.message || "Network error");
      }
    } else e.request ? console.error("No response received from server") : console.error("Request error:", e.message);
...
function jn(e, t, r) {
  return Y.post(e, t, {
    ...
    onUploadProgress: r ? (n) => {
      Math.round(n.loaded * 100 / n.total), r(n);
    } : void 0
  });
}
export {
